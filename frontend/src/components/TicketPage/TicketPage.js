...
import companylogo from "../../components/generated-image.png";
export default function TicketPage({ history }) {
    ...
    return (
        ...
        <div className="container overflow-hidden">
            <div>
                <nav className=" navbar navbar-expand-lg navbar-dark bg-unique hm-gradient">
                    <a href="/#" className="navbar-brand Company-Log"><img src={companylogo}  style={{ maxWidth: "150px", height: "auto" }} /></a>
