    ...
    if (passArray) {
        try {
            ...
            if (Array.isArray(nameArray)) {
                ...
                return <p>Invalid passenger data.</p>;
            }
        } catch (e) {
            console.error("Error parsing nameData:", e);
            return <p>Error loading passengers.</p>;
        }
    } else {
        return <p>No passenger data found.</p>;
    }
    };
